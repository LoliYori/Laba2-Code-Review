...
int main() {
    ...
    while (true) {
        ...
        while (!IsValidInput(choice) || choice < 1 || choice > 5) {
            std::cout << "Ошибка: Введите число от 1 до 5 для выбора действия.\n";
            std::cout << "Введите ваш выбор: ";
        }
        ...
        case 1:
            ...
            while (!IsValidInput(value)) {
                std::cout << "Ошибка: Введите корректное целое число для добавления в стек.\n";
                std::cout << "Введите число для добавления в стек: ";
            }
            PushAndPrintNewTopAddress(stack, value);
            break;
        case 2:
            stack.Pop();
            break;
        ...
        case 5:
            ...
            return 0;
        default:
            std::cerr << "Ошибка: Неверный выбор! Пожалуйста, попробуйте снова." << std::endl;
        }
    }
